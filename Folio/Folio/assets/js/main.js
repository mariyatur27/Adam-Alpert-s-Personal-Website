...
var skill_bars = document.getElementsByClassName('the_bars');
for (var i = 0; i < skill_bars.length; i++){
  var width = skill_bars[i].innerHTML;
  var width_num = Number(width.replace('%', ''))-30;
  var width_str = width_num.toString().concat("%")
  skill_bars[i].style.width = width_str;
}
// var i = 0;
// function move() {
//   if (i == 0) {
